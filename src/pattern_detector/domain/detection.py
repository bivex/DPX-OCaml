"""Detection and Report domain entities for OCaml Pattern Detector."""
...
class Detection:
    """Represents an identified OCaml design pattern, functor idiom, or safety vulnerability."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "module", "functor", "type", "function", "effect_handler", "gadt"
...
class DetectionReport:
    """Aggregated findings report of an OCaml codebase scan."""
