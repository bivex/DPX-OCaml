...
from pattern_detector.domain.rules.abstract_data_type_interface_rule import (
    AbstractDataTypeInterfaceRule,
)
from pattern_detector.domain.rules.actor_mailbox_process_rule import (
...
from pattern_detector.domain.rules.circular_module_dependency_rule import (
    CircularModuleDependencyRule,
)
from pattern_detector.domain.rules.closure_currying_strategy_rule import (
    ClosureCurryingStrategyRule,
)
from pattern_detector.domain.rules.cps_continuation_passing_rule import (
    CpsContinuationPassingRule,
)
from pattern_detector.domain.rules.cyclomatic_complexity_kiss_rule import (
...
from pattern_detector.domain.rules.domains_parallelism_rule import (
...
from pattern_detector.domain.rules.module_inclusion_extender_rule import (
