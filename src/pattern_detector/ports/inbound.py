"""Inbound (driver) ports for the OCaml pattern detector application layer."""
...
@dataclass
class ScanOptions:
    """Configuration options for an OCaml codebase scan execution."""
...
class ScannerPort(Protocol):
    """Primary inbound port for scanning OCaml codebases and returning DetectionReports."""
...
class DetectorPort(Protocol):
    """Inbound port for executing pattern detection rules on an OCaml CodeModel."""
