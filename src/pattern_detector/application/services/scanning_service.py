"""Application scanning service orchestrating OCaml source retrieval, parsing, and rule execution."""
...
class ScanningService(ScannerPort):
    """End-to-end scanning orchestrator for OCaml projects and libraries."""
