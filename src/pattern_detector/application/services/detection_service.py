"""Application service for running pattern detection rules against an OCaml CodeModel."""
...
class DetectionService(DetectorPort):
    """Coordinates the execution of all registered OCaml pattern detection rules."""
